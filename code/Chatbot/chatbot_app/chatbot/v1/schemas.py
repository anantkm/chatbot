...
validators = {
    ('question', 'GET'): {'args': {'required': ['expression'], 'properties': {'expression': {'description': 'an example “Hi”, “list available doctors”', 'type': 'string'}}}},
}

filters = {
    ('question', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'answer': {'type': 'string', 'example': 'How can I help you?'}}}}},
}
