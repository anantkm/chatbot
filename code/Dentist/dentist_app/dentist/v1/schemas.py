...
filters = {
    ('dentists', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'answer': {'type': 'string', 'example': 'The available dentists: Mike, Jim, Kamala, Swati, Abhishek, Pratik, Morty'}}}}},
    ('dentist_details_dname', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'answer': {'type': 'string', 'example': 'Mike has specialized in Paediatric Dentistry and located at Chatswood'}}}}, 404: {'headers': None, 'schema': {'type': 'object', 'properties': {'answer': {'type': 'string', 'example': 'specified dentists was not found in the Database. Please check the name and try again '}}}}},
}
